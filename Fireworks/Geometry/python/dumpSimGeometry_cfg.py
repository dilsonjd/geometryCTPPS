...
varType = Enumerate ("Run1CTPPS Ideal2015 Ideal2015dev 2015 2015dev 2019 PhaseIPixel Phase1_R34F16 Phase2Tk  2023Muon SLHC DB SLHCDB")
...
def simGeoLoad(score):
    ...
    if score == "Run1CTPPS":
       process.load("Configuration.Geometry.GeometryCTPPS_cfi")
